...
data_roots = [
    '/data2/itri464058/pointcloud_data/hsinchu_q2_with_markgraph/',
    '/data2/itri464058/pointcloud_data/airport_q2_with_markgraph/'
]

domain_names = ['hsinchu_q2_with_markgraph', 'airport_q2_with_markgraph']

ignore_index = -1
names = ['none', 'solid', 'broken', 'solid_solid', 'solid_broken', 'broken_solid', 'broken_broken', 'botts_dots', 'grass', 'curb', 'custom', 'edge', 'channelizing_line','hatching','directional_arrow','slow_mark','motorcycle_waiting_zone','pedestrian_crossing']
...
#         type='ItriDataset',
#         split='train',
#         data_root='/data2/itri464058/pointcloud_data/hsinchu_q2/',  # Single path for single domain
#         transform=[
